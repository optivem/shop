package com.mycompany.myshop.sysapp.api.exception;
...
import com.mycompany.myshop.sysapp.core.validation.TypeValidationMessageExtractor;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final Pattern CLASS_NAME_PATTERN = Pattern.compile(
            "(com\\.mycompany\\.myshop\\.sysapp\\.core\\.dtos\\.[^\\[\\]\"\\s\\)]+)");
