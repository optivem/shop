package com.optivem.starter.backend.api.exception;
...
import com.optivem.starter.backend.core.validation.TypeValidationMessageExtractor;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final Pattern CLASS_NAME_PATTERN = Pattern.compile("(com\\.optivem\\.starter\\.backend\\.core\\.dtos\\.[^\\[\\]\"\\s\\)]+)");
