 ...
 * to the ERP stub + real {@code ErpProductDetailsResponse} parse), not through a test-side stub client.
 * That backing is what lets these assertions catch a real field drift in the component stub — see
 * {@link com.mycompany.myshop.backend.testkit.dsl.port.then.ThenStage}.
 */
