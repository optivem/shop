 ...
 * HTTP at all — in {@code REAL} mode {@link HttpClockGateway} short-circuits to {@code Instant.now()}
 * and never calls the clock service, so there would be no wire format to pin.
 *
