...
/**
 * Shared shape for the clock time contract: does the production {@link ClockGateway} adapter's parse
 * still agree with whatever is answering at {@link #clockGateway()}'s URL?
