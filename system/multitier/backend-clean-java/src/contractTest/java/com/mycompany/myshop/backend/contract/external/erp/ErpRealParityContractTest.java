 ...
 * side proves the production {@link HttpErpGateway} still agrees with our own guess about the ERP,
 * this side proves it still agrees with the real thing.
 *
 ...
 * too. A red run here beside a green component run means the stub is lying and every component test
 * leaning on it is currently proving nothing; the fix is the pair, stub and component expectations
 * together.
 *
