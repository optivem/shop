...
//
// hasMore is answered by asking for one row more than the page size and seeing whether it
// arrives. That is one row cheaper than a second COUNT(*) over the same predicate, and it is
...
//
// The next cursor is not held here. It is the sort key of last(), and which columns make
