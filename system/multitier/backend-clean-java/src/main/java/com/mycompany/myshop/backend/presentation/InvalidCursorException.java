...
/**
 * A cursor that did not come from {@link CursorCodec}. It is a 400 rather than a 422: the token is
 * not a field the caller got wrong, it is a value the caller was never meant to author.
 *
 * <p>Carries no detail about why it failed, deliberately. Explaining the decode is explaining the
