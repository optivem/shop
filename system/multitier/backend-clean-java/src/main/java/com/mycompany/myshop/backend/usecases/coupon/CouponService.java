...
/**
 * Still one grab-bag service: Step 6 of the refactor plan splits the two real use cases
 * ({@code PublishCoupon}, {@code BrowseCoupons}) out, and Step 8 moves {@code getDiscount} and
 * {@code incrementUsageCount} onto the {@link Coupon} entity where they belong.
 */
@Service
public class CouponService {
    ...
    public BigDecimal getDiscount(String couponCode) {
        ...
        // Check usage limit only if it is set (not null)
