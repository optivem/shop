...
class PlaceOrderNegativeTest extends BaseE2eTest {
    ...
    void shouldRejectOrderWithInvalidQuantity() {
        app.shop().placeOrder().sku(SKU).quantity("invalid-quantity").execute()
                .shouldFail()
    ...
    void shouldRejectOrderWithNonExistentSku() {
        app.shop().placeOrder().sku("NON-EXISTENT-SKU-12345").quantity(QUANTITY).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
    ...
    void shouldRejectOrderWithNegativeQuantity() {
        app.shop().placeOrder().sku(SKU).quantity(-10).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
    ...
    void shouldRejectOrderWithZeroQuantity() {
        app.shop().placeOrder().sku("ANOTHER-SKU-67890").quantity(0).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
                .fieldErrorMessage("quantity", "Quantity must be positive");
    }
    ...
    void shouldRejectOrderWithEmptySku(String sku) {
        app.shop().placeOrder().sku(sku).quantity(QUANTITY).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
    ...
    void shouldRejectOrderWithEmptyQuantity(String emptyQuantity) {
        app.shop().placeOrder().sku(SKU).quantity(emptyQuantity).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
    ...
    void shouldRejectOrderWithNonIntegerQuantity(String nonIntegerQuantity) {
        app.shop().placeOrder().sku(SKU).quantity(nonIntegerQuantity).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
                .fieldErrorMessage("quantity", "Quantity must be an integer");
    }
    ...
    void shouldRejectOrderWithNullQuantity() {
        app.shop().placeOrder().sku(SKU).quantity(null).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
                .fieldErrorMessage("quantity", "Quantity must not be empty");
    }
    ...
    void shouldRejectOrderWithNullSku() {
        app.shop().placeOrder().sku(null).quantity(QUANTITY).execute()
                .shouldFail()
                .errorMessage("The request contains one or more validation errors")
                .fieldErrorMessage("sku", "SKU must not be empty");
    }
