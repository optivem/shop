...
> Generated by the `diagrams-generate` agent from the prose docs in `docs/atdd/<architecture|process>/`. Overwritten on every run — do not edit by hand; edit the source docs and regenerate.
