...
flowchart TD
    ...
    extcontract --> extcontractreal[Run External System Contract Tests - Real ERP]:::component
    extcontractreal --> linter[Run Linter]
...
| Run External System Contract Tests (Real ERP) | Run External System Contract Tests - Real ERP (`gh optivem component-test run --suite external-contract-real`, `run` job; backend-java only — the real half of the stub-vs-real parity pair, simulator supplied by Testcontainers) |
